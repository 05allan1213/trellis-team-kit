...
- Task-creation consent has been obtained (dual-consent gate 1).
...
Do not start implementation until the user approves or asks for implementation. That requires implementation consent (dual-consent gate 2).

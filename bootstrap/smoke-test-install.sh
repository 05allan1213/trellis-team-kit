...
run_case() {
  ...
  assert_file "$project/.trellis/replay/orchestration/subagent-mode-requires-checker-result.json"
  assert_file "$project/.trellis/replay/review/review-gate-missing-reviewer-result.json"
  assert_file "$project/.trellis/replay/review/review-gate-template-placeholder-fails.json"
